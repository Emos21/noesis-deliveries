...
1. Open `opening-hours.html` on a computer or a phone.
2. Choose Print. It is already set to one sheet of A4, standing upright.
3. Cut along the outer black line and stick it on the door.
